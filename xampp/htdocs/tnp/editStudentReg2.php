  ...
  <div class="container-fluid">
    ...
    <li><a href="adminLogin.php">Admin Login</a></li>                         
        ...
        <?php
             ...
             $q="update sreg set name='$b',branch='$c', sem='$d', email='$e', gender='$f', mob='$g', address='$h', tenthp='$i',tenthb='$j', tenthpy='$k',twelthp='$l', twelthb='$m', twelthpy='$n', gp='$o', gb='$p', gpy='$q',  hobbies='$r', resume='$sfn', password='$t' where rno=$a";
