...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <form action="studentLogin1.php" name="stLogin" method="post" 
        enctype="multipart/form-data">
        User(Roll No.)<input type="text" name='t1' class="form-control" id="t1" placeholder="Enter your Student Id"><br>
        Password<input type="text" name='t2' class="form-control" id="t2" placeholder="Enter your password"><br>
...
$(function() {
  ...
  $("form[name='stLogin']").validate({
    ...
    messages: {
      t1: {
        required: "Please enter your roll as user name ",
