...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <form action="editStudentReg1.php" method="post" 
        enctype="multipart/form-data">

        User(Roll No.)<input type="text" name='t1' class="form-control" placeholder="Enter your Student Id"><br>        
        <input type="submit" value="Go" class="btn btn-info x">
